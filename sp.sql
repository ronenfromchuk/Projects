...
------------------------------------------------
SELECT * FROM get_airline_by_username('jesse');
------------------------------------------------
...
LANGUAGE plpgsql AS
    ...
    $$;
--------------------------------------------------
SELECT * FROM get_customer_by_username('ajoshua');
---------------------------------------------------
...
LANGUAGE plpgsql AS
    ...
    $$;
--------------------------------------------
SELECT * FROM get_user_by_username('ronen');
--------------------------------------------
...
LANGUAGE plpgsql AS
    ...
    $$;
--------------------------------------------------------------------
SELECT * FROM get_flights_by_parameters(4, 1, '2022-04-01 12:00:00');
--------------------------------------------------------------------
